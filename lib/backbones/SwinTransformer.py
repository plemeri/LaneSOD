...
def SwinB(pretrained=True):
    ...
    if pretrained:
        model.load_state_dict(torch.load('data/backbone_ckpt/swin_base_patch4_window12_384_22kto1k.pth', map_location='cpu')['model'])
...
def SwinB_224(pretrained=True):
    ...
    if pretrained:
        model.load_state_dict(torch.load('data/backbone_ckpt/swin_base_patch4_window7_224_22kto1k.pth', map_location='cpu')['model'])
